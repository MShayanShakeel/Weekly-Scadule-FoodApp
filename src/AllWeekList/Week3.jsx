...
// MODEL CODE LLOGIC END
  ...
  const savedItemValues = localStorage.getItem("selectedWeek2");
  const savedGetCardId = localStorage.getItem("getCardId2");
  ...
  const handleRemoveitem = () => {
    if (parsedItemValues === "week3") {
      localStorage.removeItem("getCardId2");
      localStorage.removeItem("selectedWeek2");
      console.log("Item removed successfully.");
    } else {
      console.log(
        "Something went wrong: savedItemValues does not match 'week3'."
      );
    }
  };
      ...
      <div className="ItemsSection-Main">
        ...
        <div className="ItemsSection-Cards">
          {parsedItemValues === "week3" ? (
            ...
            <p>No recipes available  in Week 3.</p>
          )}
        </div>
